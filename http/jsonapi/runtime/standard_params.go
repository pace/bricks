...
type ValueSanitizer interface {
	...
	SanitizeValue(fieldName string, value string) (any, error)
}
...
func getFilterValues(fieldName string, queryValues []string, sanitizer ValueSanitizer) ([]any, bool) {
	var filterValues []any

	for _, value := range queryValues {
		for separatedValue := range strings.SplitSeq(value, ",") {
