...
func TestMarshal_attrStringSlice(t *testing.T) {
	...
	attributesMap, ok := dataMap["attributes"].(map[string]interface{})
	if !ok {
		t.Fatal("data.attributes was not a map")
	}

	jsonTags, ok := attributesMap["tags"].([]interface{})
	if !ok {
...
func TestWithoutOmitsEmptyAnnotationOnRelation(t *testing.T) {
	...
	relationships, ok := dataMap["relationships"].(map[string]interface{})
	if !ok {
...
func TestWithOmitsEmptyAnnotationOnRelation(t *testing.T) {
	...
	payload, ok := jsonData["data"].(map[string]interface{})
	if !ok {
		t.Fatal("data was not a map")
	}
...
func TestWithOmitsEmptyAnnotationOnRelation_MixedData(t *testing.T) {
	...
	relationships, ok := payload["relationships"].(map[string]interface{})
	if !ok {
		t.Fatal("data.relationships was not a map")
	}
...
func TestRelations(t *testing.T) {
	...
	if relations["posts"] == nil {
		...
		if posts, ok := relations["posts"].(map[string]interface{}); !ok || posts["links"] == nil {
			t.Fatalf("Posts relationship links were not materialized")
		}

		if posts, ok := relations["posts"].(map[string]interface{}); !ok || posts["meta"] == nil {
	...
	if relations["current_post"] == nil {
		...
		if currentPost, ok := relations["current_post"].(map[string]interface{}); !ok || currentPost["links"] == nil {
			t.Fatalf("Current post relationship links were not materialized")
		}

		if currentPost, ok := relations["current_post"].(map[string]interface{}); !ok || currentPost["meta"] == nil {
			t.Fatalf("Current post relationship meta were not materialized")
		}
	}

	posts, ok := relations["posts"].(map[string]interface{})
	if !ok {
		t.Fatalf("Expected posts to be a map")
	}

	postsData, ok := posts["data"].([]interface{})
	if !ok {
