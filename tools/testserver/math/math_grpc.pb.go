...
type MathServiceClient interface {
	...
	Substract(ctx context.Context, in *Input, opts ...grpc.CallOption) (*Output, error)
}
...
func (c *mathServiceClient) Substract(ctx context.Context, in *Input, opts ...grpc.CallOption) (*Output, error) {
	out := new(Output)
	err := c.cc.Invoke(ctx, "/Math.MathService/Substract", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MathServiceServer interface {
	...
	Substract(context.Context, *Input) (*Output, error)
...
func (UnimplementedMathServiceServer) Substract(context.Context, *Input) (*Output, error) {
...
func _MathService_Substract_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Input)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MathServiceServer).Substract(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Math.MathService/Substract",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MathServiceServer).Substract(ctx, req.(*Input))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MathService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _MathService_Substract_Handler,
		},
	},
